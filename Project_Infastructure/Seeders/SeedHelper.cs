    ...
    public class SeedHelper
    {
        public static async Task Initialize(IServiceProvider serviceProvider)
        {
            ...
            if (!context.TblImage.Any())
            {
				...
				"C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\babyhamper.jpg");
				...
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\baby_clothes_hamper.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "babyclothes";
				img = ms.ToArray();
				await context.TblImage.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\baby_hamper.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "babyHamper2";
				img = ms.ToArray();
				await context.TblImage.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\babyboy_hamper.png");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				...
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\christmas_hamper.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "christmas";
				img = ms.ToArray();
				await context.TblImage.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\disney_kids.jpeg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "disney_kids";
				img = ms.ToArray();
				await context.TblImage.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\hamper_for_her.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "hamper-for-her";
				img = ms.ToArray();
				await context.TblImage.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\happy_birthday1.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "birthdayHamper";
				img = ms.ToArray();
				await context.TblImage.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\Healthy_fruits.jpeg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "FruitHamper";
				img = ms.ToArray();
				await context.TblImage.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\Kids_Sweets.jpeg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "Sweets";
				img = ms.ToArray();
				await context.TblImage.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\Men_Chocolates.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				...
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\male_hamper1.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				...
				image = System.Drawing.Image.FromFile("C:\\Users\\student\\source\\repos\\FinalProject_Hamper\\Project_UI\\wwwroot\\static\\img\\Special_Wine_Cheese.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
