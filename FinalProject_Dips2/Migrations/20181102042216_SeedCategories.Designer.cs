...
namespace FinalProject_Dips2.Migrations
{
    ...
    [Migration("20181102042216_SeedCategories")]
            ...
            modelBuilder.Entity("FinalProject_Dips2.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new { CategoryId = 1, CategoryName = "Womens" },
                        new { CategoryId = 2, CategoryName = "Men" },
                        new { CategoryId = 3, CategoryName = "Children" },
                        new { CategoryId = 4, CategoryName = "Special Occcasions" },
                        new { CategoryId = 5, CategoryName = "Baby" }
                    );
                });
