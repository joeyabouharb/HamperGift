    ...
    public class SeedHampers
    {
        public static async Task Initialize(IServiceProvider serviceProvider)
        {
            ...
            if (!context.TblImages.Any())
            {
				...
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\baby_clothes_hamper.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "babyclothes";
				img = ms.ToArray();
				await context.TblImages.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\baby_hamper.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "babyHamper2";
				img = ms.ToArray();
				await context.TblImages.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\babyboy_hamper.png");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				...
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\christmas_hamper.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "christmas";
				img = ms.ToArray();
				await context.TblImages.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\disney_kids.jpeg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "disney_kids";
				img = ms.ToArray();
				await context.TblImages.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\hamper_for_her.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "hamper-for-her";
				img = ms.ToArray();
				await context.TblImages.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\happy_birthday1.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "birthdayHamper";
				img = ms.ToArray();
				await context.TblImages.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\Healthy_fruits.jpeg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "FruitHamper";
				img = ms.ToArray();
				await context.TblImages.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\Kids_Sweets.jpeg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "Sweets";
				img = ms.ToArray();
				await context.TblImages.AddAsync(new Image { FileName = image.Tag.ToString(), ContentType = "image/jpeg", Data = img });
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\Men_Chocolates.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				...
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\male_hamper1.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
				image.Tag = "hamper-for-her";
				img = ms.ToArray();
				...
				image = System.Drawing.Image.FromFile("C:\\Users\\joeha\\source\\repos\\FinalProject_Dips2\\FinalProject_Dips2\\wwwroot\\static\\img\\Special_Wine_Cheese.jpg");
				ms = new MemoryStream();
				image.Save(ms, image.RawFormat);
            ...
            if (!context.TblHamper.Any())
            {
				...
				await context.TblHamper.AddAsync(new Hamper { HamperName = "Newborn Baby Hamper (boy)", CategoryId = 2, ImageId = 3, Cost = 85.00M });
				await context.TblHamper.AddAsync(new Hamper { HamperName = "Newborn Baby Hamper ValuePack", CategoryId = 2, ImageId = 4, Cost = 30.00M });
				await context.TblHamper.AddAsync(new Hamper { HamperName = "Newborn Baby Clothes", CategoryId = 2, ImageId = 2, Cost = 30.00M });
				await context.TblHamper.AddAsync(new Hamper { HamperName = "Chiristmas Hamper", CategoryId = 5, ImageId = 5, Cost = 145.00M });
				await context.TblHamper.AddAsync(new Hamper { HamperName = "disney hamper", CategoryId = 6, ImageId = 6, Cost = 60.00M });
				await context.TblHamper.AddAsync(new Hamper { HamperName = "Hampers for her", CategoryId = 4, ImageId = 7, Cost = 85.00M });
				await context.TblHamper.AddAsync(new Hamper { HamperName = "Birthday hamper", CategoryId = 6, ImageId = 8, Cost = 115.00M });
				await context.TblHamper.AddAsync(new Hamper { HamperName = "Fruit hamper", CategoryId = 5, ImageId = 9, Cost = 20.00M });
				await context.TblHamper.AddAsync(new Hamper { HamperName = "Sweets for kids", CategoryId = 6, ImageId = 10, Cost = 25.00M });
				await context.TblHamper.AddAsync(new Hamper { HamperName = "Mens Chocolates", CategoryId = 3, ImageId = 11, Cost = 45.00M });
				await context.TblHamper.AddAsync(new Hamper { HamperName = "Mens Deluxe Hamper", CategoryId = 3, ImageId = 12, Cost = 95.00M });
				await context.TblHamper.AddAsync(new Hamper { HamperName = "Special Wine and Snacks hamper", CategoryId = 5, ImageId = 13, Cost = 105.00M });
